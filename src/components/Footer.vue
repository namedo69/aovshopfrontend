    ...
    <div class="container footer-content">
      <div class="footer-grid">
        ...
        <div class="footer-section shop-info">
          ...
          <p class="shop-tagline">⚡ Nạp thẻ tự động 24/7 &nbsp;•&nbsp; 🛡️ Giao dịch an toàn &nbsp;•&nbsp; 🎧 Hỗ trợ nhanh chóng</p>
        ...
        <!-- Account -->
        <div class="footer-section">
          <h4 class="section-title">Tài Khoản Của Tôi</h4>
          <ul class="footer-links">
            <li><router-link to="/orders">Đơn Hàng</router-link></li>
            <li><router-link to="/cart">Giỏ Hàng</router-link></li>
            <li><router-link to="/deposit">Lịch Sử Nạp Tiền</router-link></li>
